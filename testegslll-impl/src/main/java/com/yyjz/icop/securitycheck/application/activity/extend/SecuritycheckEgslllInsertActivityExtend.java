package com.yyjz.icop.securitycheck.application.activity.extend;
 ...
 */
@Activity
public class SecuritycheckEgslllInsertActivityExtend extends SecuritycheckEgslllInsertActivity{
